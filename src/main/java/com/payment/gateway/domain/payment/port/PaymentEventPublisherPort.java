...
public interface PaymentEventPublisherPort {
    ...
    void publishPaymentFailed(
            String paymentId, String merchantId, String amount, String currency, String errorCode, String errorMessage);

    void publishPaymentCancelled(String paymentId, String merchantId, String reason);

    void publishRefundProcessed(
            String refundId,
            String paymentId,
            String merchantId,
            String refundAmount,
