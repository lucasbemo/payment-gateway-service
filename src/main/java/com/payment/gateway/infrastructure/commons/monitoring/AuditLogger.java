...
public class AuditLogger {
    ...
    public void logPaymentOperation(String paymentId, String merchantId, String operation, String status, long amount) {
        AUDIT_LOG.info(
                "PAYMENT_OPERATION | paymentId={} | merchantId={} | operation={} | status={} | amount={}",
                paymentId,
                merchantId,
                operation,
                status,
    ...
    public void logRefundOperation(String refundId, String paymentId, String merchantId, String status, long amount) {
        AUDIT_LOG.info(
                "REFUND_OPERATION | refundId={} | paymentId={} | merchantId={} | status={} | amount={}",
                refundId,
                paymentId,
                merchantId,
                status,
    ...
    public void logTransactionEvent(String transactionId, String eventType, String status) {
        AUDIT_LOG.info(
                "TRANSACTION_EVENT | transactionId={} | eventType={} | status={}", transactionId, eventType, status);
    }

    public void logSecurityEvent(String eventType, String principal, String resource, String outcome) {
        AUDIT_LOG.info(
                "SECURITY_EVENT | eventType={} | principal={} | resource={} | outcome={}",
                eventType,
                principal,
                resource,
                outcome);
    ...
    public void logDataAccess(String entityType, String entityId, String operation, String userId) {
        AUDIT_LOG.info(
                "DATA_ACCESS | entityType={} | entityId={} | operation={} | userId={}",
                entityType,
                entityId,
                operation,
                userId);
    ...
    public void logWebhookDelivery(
        ...
        AUDIT_LOG.info(
                "WEBHOOK_DELIVERY | merchantId={} | eventType={} | webhookUrl={} | outcome={} | attempts={}",
                merchantId,
                eventType,
                webhookUrl,
                outcome,
    ...
    public void logAuthenticationEvent(String principal, String outcome, String reason) {
        AUDIT_LOG.info("AUTHENTICATION | principal={} | outcome={} | reason={}", principal, outcome, reason);
    }

    public void logApiAccess(String method, String path, String userId, String status) {
        AUDIT_LOG.info("API_ACCESS | method={} | path={} | userId={} | status={}", method, path, userId, status);
    }

    public void logRateLimitEvent(String merchantId, int attempts, String action) {
        AUDIT_LOG.info("RATE_LIMIT | merchantId={} | attempts={} | action={}", merchantId, attempts, action);
    }

    public void logCircuitBreakerEvent(String serviceName, String state, String reason) {
        AUDIT_LOG.info("CIRCUIT_BREAKER | serviceName={} | state={} | reason={}", serviceName, state, reason);
    }
}
