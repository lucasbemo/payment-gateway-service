...
public class SwaggerConfig {
    ...
    private List<Server> servers() {
        return Arrays.asList(
                ...
                new Server().url("https://dev.payment-gateway.com").description("Development Server"),
                new Server().url("https://api.payment-gateway.com").description("Production Server"));
    }
    ...
    private List<Tag> tags() {
        return Arrays.asList(
                ...
                new Tag()
                        ...
                        .description("Customer registration and payment method management"),
