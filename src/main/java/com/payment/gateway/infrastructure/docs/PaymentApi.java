...
public interface PaymentApi {
    ...
    ResponseEntity<
                    com.payment.gateway.infrastructure.commons.rest.ApiResponse<
                            com.payment.gateway.infrastructure.payment.adapter.in.rest.PaymentResponse>>
            processPayment(
                    @Parameter(
                                    name = "X-Idempotency-Key",
                                    description =
                                            "Unique key for idempotent requests (UUID recommended). Stored for 24 hours.",
                                    required = true,
                    ...
                    @RequestBody(
                                    ...
                                    content =
                                            @Content(
                                                    ...
                                                    schema =
                                                            @Schema(
                                                                    implementation =
                                                                            com.payment.gateway.infrastructure.payment
                                                                                    .adapter.in.rest
                            ...
                            """)))
                            @Valid
                            com.payment.gateway.infrastructure.payment.adapter.in.rest.CreatePaymentRequest request);
    ...
    ResponseEntity<
                    com.payment.gateway.infrastructure.commons.rest.ApiResponse<
                            List<com.payment.gateway.infrastructure.payment.adapter.in.rest.PaymentResponse>>>
            getPayments(
                    @Parameter(
                                    name = "merchantId",
