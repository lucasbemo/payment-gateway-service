...
public interface ReconciliationApi {
    ...
    ResponseEntity<
                    com.payment.gateway.infrastructure.commons.rest.ApiResponse<
                            com.payment.gateway.application.reconciliation.dto.ReconciliationResponse>>
    ...
    ResponseEntity<
                    com.payment.gateway.infrastructure.commons.rest.ApiResponse<
                            com.payment.gateway.application.reconciliation.dto.SettlementReportDTO>>
            generateSettlementReport(
                    ...
                    @Parameter(
                                    ...
                                    example = "2026-03-20")
                            String endDate,
                    @Parameter(name = "format", description = "Report format (JSON, CSV, PDF)", example = "JSON")
                            String format);
}
