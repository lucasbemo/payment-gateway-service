...
public interface RefundApi {
    ...
    ResponseEntity<ApiResponse<RefundResponse>> processRefund(
            @RequestBody(
                            ...
                            """)))
                    @Valid
                    RefundController.CreateRefundRequest request);
    ...
    ResponseEntity<ApiResponse<RefundResponse>> getRefund(
            @Parameter(name = "id", description = "Unique refund identifier", required = true, example = "ref_abc123")
                    String id,
            @Parameter(
                            name = "merchantId",
    ...
    ResponseEntity<ApiResponse<RefundResponse>> cancelRefund(
            @Parameter(name = "id", description = "Refund ID to cancel", required = true, example = "ref_abc123")
                    String id,
            @Parameter(
                            name = "merchantId",
                            description = "Merchant ID for authorization",
                            ...
                            example = "merch_xyz789")
                    String merchantId,
            @Parameter(name = "reason", description = "Reason for cancellation", example = "Customer changed mind")
                    String reason);
}
