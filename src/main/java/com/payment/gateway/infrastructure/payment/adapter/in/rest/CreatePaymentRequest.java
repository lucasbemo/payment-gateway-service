...
public class CreatePaymentRequest {
    ...
    @Schema(description = "Customer ID (optional if using paymentMethodId directly)", example = "cust_123abc")
    ...
    @Schema(description = "Payment description for merchant records", example = "Order #12345")
