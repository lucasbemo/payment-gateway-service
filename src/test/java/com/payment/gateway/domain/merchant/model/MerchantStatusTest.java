...
class MerchantStatusTest {
    ...
    class PendingTransitions {
        ...
        void pendingCanTransitionToActive() {
            assertThat(MerchantStatus.PENDING.canTransitionTo(MerchantStatus.ACTIVE))
                    .isTrue();
        }
        ...
        void pendingCanTransitionToSuspended() {
            assertThat(MerchantStatus.PENDING.canTransitionTo(MerchantStatus.SUSPENDED))
                    .isTrue();
        }
        ...
        void pendingCannotTransitionToClosed() {
            assertThat(MerchantStatus.PENDING.canTransitionTo(MerchantStatus.CLOSED))
                    .isFalse();
        }
    }
    ...
    class ActiveTransitions {
        ...
        void activeCanTransitionToSuspended() {
            assertThat(MerchantStatus.ACTIVE.canTransitionTo(MerchantStatus.SUSPENDED))
                    .isTrue();
        }
        ...
        void activeCanTransitionToClosed() {
            assertThat(MerchantStatus.ACTIVE.canTransitionTo(MerchantStatus.CLOSED))
                    .isTrue();
        }
        ...
        void activeCannotTransitionToPending() {
            assertThat(MerchantStatus.ACTIVE.canTransitionTo(MerchantStatus.PENDING))
                    .isFalse();
        }
    }
    ...
    class SuspendedTransitions {
        ...
        void suspendedCanTransitionToActive() {
            assertThat(MerchantStatus.SUSPENDED.canTransitionTo(MerchantStatus.ACTIVE))
                    .isTrue();
        }
        ...
        void suspendedCanTransitionToClosed() {
            assertThat(MerchantStatus.SUSPENDED.canTransitionTo(MerchantStatus.CLOSED))
                    .isTrue();
        }
        ...
        void suspendedCannotTransitionToPending() {
            assertThat(MerchantStatus.SUSPENDED.canTransitionTo(MerchantStatus.PENDING))
                    .isFalse();
        }
    }
    ...
    class ClosedTransitions {
        ...
        void closedCannotTransitionToAnyStatus() {
            assertThat(MerchantStatus.CLOSED.canTransitionTo(MerchantStatus.PENDING))
                    .isFalse();
            assertThat(MerchantStatus.CLOSED.canTransitionTo(MerchantStatus.ACTIVE))
                    .isFalse();
            assertThat(MerchantStatus.CLOSED.canTransitionTo(MerchantStatus.SUSPENDED))
                    .isFalse();
        }
    }
    ...
    class ParseFromStringTests {
        ...
        void shouldThrowExceptionForNullStatus() {
            assertThatThrownBy(() -> MerchantStatus.fromString(null)).isInstanceOf(IllegalArgumentException.class);
        }
    }
}
